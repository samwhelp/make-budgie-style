...
## ## Link
##
## * https://github.com/samwhelp/make-budgie-style/blob/main/make-budgie-style.sh
## * https://raw.githubusercontent.com/samwhelp/make-budgie-style/refs/heads/main/make-budgie-style.sh
##
...
portal_budgie_style_install () {

	echo
	echo
	echo "##"
	echo "## ## portal_budgie_style_install"
	echo "##"
	echo
	echo

	mod_budgie_style_install_prerun

	mod_budgie_style_install_mainrun

	mod_budgie_style_install_postrun
